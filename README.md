...
- ![1-aws-console-home.png](./images/1-aws-console-home.png)

### 2.2 Start to create Cloudformation


- ![2-stacks.png](./images/2-stacks.png)

- ![3-create-stack.png](./images/3-create-stack.png)

- ![4-select-template.png](./images/4-select-template.png)
...
- ![7-verify-config.png](./images/7-verify-config.png)
...
- ![8-cf-stack-creating.png](./images/8-cf-stack-creating.png)
...
- ![8-pipe-line-failed.png](./images/8-pipe-line-failed.png)
...
- ![9-connection.png](./images/9-connection.png)

- ![10-aits-infra-github-connection.png](./images/10-aits-infra-github-connection.png)

- ![11-update-pending-connection.png](./images/11-update-pending-connection.png)

- ![12-install-new-app.png](./images/12-install-new-app.png)

- ![12-select-git-account.png](./images/12-select-git-account.png)

- ![13-select-required-repo.png](./images/13-select-required-repo.png)
...
- ![14-initiate-release-changes.png](./images/14-initiate-release-changes.png)

- ![15-release.png](./images/15-release.png)
...
- ![16-build-start.png](./images/16-build-start.png)

- ![17-deployment.png](./images/17-deployment.png)

- ![18-deployment-code-artifact.png](./images/18-deployment-code-artifact.png)

- ![19-deployment-done.png](./images/19-deployment-done.png)
